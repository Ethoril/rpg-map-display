...
| **4 — Hexagone & confort de table** | **1 sur 6**, et c’est une tranche du lot 2 qui l’a ouvert : **L-06 ferme « Undo restaure l’état fog précédent »**, l’undo n’ayant de sens qu’avec le fog. ⭐ **Débloqué le 12/08/2026** : les deux décisions qui interdisaient d’écrire `HexGrid` sont prises (§12 q.5 et q.6). ⭐ **Et ce lot est en réalité deux lots indépendants** : trois critères hexagonaux, deux critères de confort de table — mesure au geste et ping — qui ne dépendent d’aucune décision et se livrent sans risque de conception. Ordre retenu par le mainteneur : **le confort d’abord** |
